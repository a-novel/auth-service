...
type mockConstructorTestingTNewUpdatePasswordService interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewUpdatePasswordService(t mockConstructorTestingTNewUpdatePasswordService) *UpdatePasswordService {
