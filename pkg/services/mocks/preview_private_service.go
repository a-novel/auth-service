...
type mockConstructorTestingTNewPreviewPrivateService interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewPreviewPrivateService(t mockConstructorTestingTNewPreviewPrivateService) *PreviewPrivateService {
