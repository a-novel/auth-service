...
type mockConstructorTestingTNewUpdateIdentityService interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewUpdateIdentityService(t mockConstructorTestingTNewUpdateIdentityService) *UpdateIdentityService {
